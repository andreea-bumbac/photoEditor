...
class FilterFrame(Toplevel):
    ...
    def __init__(self, master=None):
        ...
        self.negative_button = Button(master=self,font="y", fg='SlateBlue2', text="Negative")
        self.black_white_button = Button(master=self,font="y",  text="Black White")
        self.sepia_button = Button(master=self,font="y",fg='gold',  text="Sepia")
        self.emboss_button = Button(master=self,font="y",fg='saddle brown',  text="Emboss")
        self.gaussian_blur_button = Button(master=self,font="y", fg='DarkOrange1', text="Gaussian Blur")
        self.median_blur_button = Button(master=self,font="y", fg='magenta4', text="Median Blur")
        self.cancel_button = Button(master=self,font="y", fg='red', text="Cancel")
        self.apply_button = Button(master=self,font="y", fg='lawn green', text="Apply")
